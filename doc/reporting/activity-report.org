...
** TODO Permettre à l'étudiant d'exécuter son code
...
*** TODO Le web-service renvoie le résultat au client
...
** TODO Afficher les étapes de l'exécution du code de l'étudiant
*** TODO Modifier les interactions entre le client et le serveur
    - Pour permettre au serveur d'envoyer des données en continu au
      client lors de l'exécution d'un programme, une WebSocket est
      requise.
*** TODO Permettre à PLM de streamer l'exécution du code
    - Créer une classe basée sur [[https://github.com/oster/PLM/blob/command-view/src/plm/universe/Bridge.java][Bridge]] et [[https://github.com/oster/PLM/blob/command-view/src/plm/universe/ISender.java][ISender]] enregistrant les
      ...
      stream.
    - Cette classe doit-elle indiquer la fin de l'exécution du programme au client?
*** TODO Transmettre le stream de l'exécution du code au client
    - Le serveur doit rediriger le stream dans la websocket du client.
** TODO Refactorer l'architecture du projet
