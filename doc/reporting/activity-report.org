...
** DONE Ajouter des types d'opérations supplémentaires
   ...
   - ChangeCellColor
** TODO Ajouter la gestion des baggles
** TODO Récupérer l'état objectif du monde
   ...
   - Nous n'avons alors pas besoin de rejouer la solution côté serveur
     lorsque l'étudiant souhaite voir la démo, puisque nous possèdons
     alors les opérations de la solution.
** TODO Permettre à l'utilisateur de passer d'un monde à l'autre
   ...
   - L'utilisateur doit pouvoir passer d'un à l'autre pour observer le
     ...
     conditions.
** TODO Refactorer drawBuggleImage
   - La méthode actuelle rencontre des difficultés à changer la
     couleur du Buggle: getImageData permet de récupérer les pixels
...
** TODO Mettre en place de reconnexion de la websocket
