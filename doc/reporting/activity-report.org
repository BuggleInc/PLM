...
<<<<<<< Updated upstream
** TODO Ajouter pop-up au démarrage informant l'utilisateur que PLM conserve une trace de son activité suite au [[https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=772026][bug report suivant]]
   SCHEDULED: <2014-12-05 ven.>
** TODO Permettre aux utilisateurs de désactiver l'envoi de la trace de leur activité au repo central
   SCHEDULED: <2014-12-05 ven.>
...
** DONE Modifier PLM pour disposer d'une liste de leçons initialisées au lancement
   ...
   - Les exercices des leçons et leurs solutions seraient toujours
     ...
     accéder.
** TODO Charger la description d'une leçon
...
** TODO Instancier Game au lancement du serveur
   SCHEDULED: <2014-12-11 jeu.>
