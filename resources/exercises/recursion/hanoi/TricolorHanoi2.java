...
public class TricolorHanoi2 extends ExerciseTemplated {
	...
	public TricolorHanoi2() {
		...
		w = new HanoiWorld("gather(0,1,2)", slot0, slot1, slot2);
		w.setParameter(new Object[] {0,1,2});		
		myWorlds[0] = w;
		
		w = new HanoiWorld("gather(1,2,0)", slot0, slot1, slot2);
		w.setParameter(new Object[] {1,2,0});		
		myWorlds[1] = w;

		w = new HanoiWorld("gather(2,0,1)", slot0, slot1, slot2);
