...
public class SplitHanoi1 extends ExerciseTemplated {
	...
	public SplitHanoi1(FileUtils fileUtils) {
		super("SplitHanoi1", "SplitHanoi1");
		...
		w = new HanoiWorld(fileUtils, "solve(3,2,0,1)",
		...
		w = new HanoiWorld(fileUtils, "solve(1,3,0,2)",
		...
		w = new HanoiWorld(fileUtils, "solve(2,1,0,3)",
