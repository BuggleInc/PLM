...
public class TricolorHanoi3 extends ExerciseTemplated {
	...
	public TricolorHanoi3(FileUtils fileUtils) {
		super("TricolorHanoi3", "TricolorHanoi3");
		...
		w = new HanoiWorld(fileUtils, "gather(0,1,2)", slot0, slot1, slot2);
		w.setParameter(new Object[] {0,1,2});		
		myWorlds[0] = w;
		
		w = new HanoiWorld(fileUtils, "gather(1,2,0)", slot0, slot1, slot2);
		w.setParameter(new Object[] {1,2,0});		
		myWorlds[1] = w;

		w = new HanoiWorld(fileUtils, "gather(2,0,1)", slot0, slot1, slot2);
