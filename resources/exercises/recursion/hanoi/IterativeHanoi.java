...
public class IterativeHanoi extends ExerciseTemplated {
	...
	public IterativeHanoi() {
		...
		myWorlds[0] = new HanoiWorld("hanoi(0,true)",  slot00, new Vector<HanoiDisk>(), new Vector<HanoiDisk>());
		myWorlds[0].setParameter(new Object[] {0,true});		
		myWorlds[1] = new HanoiWorld("hanoi(1,true)",  new Vector<HanoiDisk>(), slot11, new Vector<HanoiDisk>());
		myWorlds[1].setParameter(new Object[] {1,true});		
		myWorlds[2] = new HanoiWorld("hanoi(1,false)", new Vector<HanoiDisk>(), slot11, new Vector<HanoiDisk>());
