...
public class CyclicHanoi extends ExerciseTemplated {
	...
	public CyclicHanoi(FileUtils fileUtils) {
		...
		myWorlds[0] = new HanoiWorld(fileUtils, "solve(0,2,1), 5 disks",
		...
		myWorlds[1] = new HanoiWorld(fileUtils, "solve(0,2,1), 4 disks",
		...
		myWorlds[2] = new HanoiWorld(fileUtils, "solve(0,2,1), 3 disks",
		...
		myWorlds[3] = new HanoiWorld(fileUtils, "solve(0,2,1), 2 disks",
