...
public class ProgrammingLanguageManager {
  ...
  public ProgrammingLanguageManager()
  {
    ...
    if (defaultProgrammingLanguageName.equalsIgnoreCase(PYTHON.getLang()))
      ...
      System.err.println(Game.i18n.tr("Warning, the default programming language is neither ''Java'' nor ''python'' or ''Scala'' or "
                                      + "''C'' but {0}.\n"
  ...
  public void setCurrent(ProgrammingLanguage newLanguage) throws BrokenProgrammingLanguageException
  {
    ...
    if (isValidProgLanguage(newLanguage)) {
      ...
      if (newLanguage.isScala() && newLanguage.isBrokenLanguage()) {
        throw new BrokenProgrammingLanguageException(Game.i18n.tr("Scala is missing"),
      ...
      if (newLanguage.isPython() && newLanguage.isBrokenLanguage()) {
        throw new BrokenProgrammingLanguageException(Game.i18n.tr("Python is missing"),
      ...
      if (newLanguage.isC() && newLanguage.isBrokenLanguage()) {
        throw new BrokenProgrammingLanguageException(Game.i18n.tr("C is missing"),
      ...
      if (newLanguage.isJava() || newLanguage.isPython() || newLanguage.isScala() || newLanguage.isC()) // Only save it if it's stable enough
