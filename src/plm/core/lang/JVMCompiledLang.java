...
public abstract class JVMCompiledLang extends ProgrammingLanguage {
  public JVMCompiledLang(String lang, String ext, ImageIcon i) { super(lang, ext, i); }
  ...
  protected String className(String name) { return packageName() + "." + name; }
        ...
        try {
          ...
          if (whatToMutate == StudentOrCorrection.STUDENT) {
            if (Game.getInstance().getProgrammingLanguage().isScala())
              throw new PLMCompilerException(Game.i18n.tr("Your entity failed to start. Did you forgot to put "
              ...
              throw new PLMCompilerException(Game.i18n.tr("Your entity failed to start. Your constructor seems to "
