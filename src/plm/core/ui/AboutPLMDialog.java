...
public class AboutPLMDialog extends JDialog {
  ...
  public void initComponent()
  {
    ...
    text.setOpaque(true);
    text.setText(Game.i18n.tr("<html>"
                              ...
                              Game.getSavingLocation(), Game.getInstance().getUsers().getCurrentUser().getUserUUIDasString()));
    ...
    licenseArea.setText(Game.i18n.tr("<h2>The PLM is proudly Free Software</h2>\n"
                                     + ""
                                     + "<p>Copyright (c) 2008-2021.<br/>\n "
