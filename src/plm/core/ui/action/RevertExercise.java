...
public class RevertExercise extends AbstractGameAction {
  ...
  public RevertExercise(Game game, String text, ImageIcon icon) { super(game, text, icon); }

  @Override public void actionPerformed(ActionEvent e)
  {
    Object[] options = {Game.i18n.tr("OK"), Game.i18n.tr("Cancel")};
    int choice       = JOptionPane.showOptionDialog(
        null, Game.i18n.tr("Reverting this exercise will erase all your work and cannot be undone.\n Are you sure that you want to proceed?"),
        Game.i18n.tr("Warning"), JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[0]);
    if (choice != 0) {
