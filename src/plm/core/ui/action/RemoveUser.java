...
public class RemoveUser extends AbstractGameAction {
  ...
  @Override public void actionPerformed(ActionEvent e)
  {
    ...
    User chosenUser =
        (User)JOptionPane.showInputDialog(this.parent, Game.i18n.tr("<html>Please choose from the drop-down menu the user you want to remove.</html>"),
                                          Game.i18n.tr("Remove user"), JOptionPane.OK_CANCEL_OPTION, null, possibilities, possibilities[0]);
    ...
    if (!chosenUser.equals(game.getUsers().getCurrentUser())) {
      if (JOptionPane.showConfirmDialog(this.parent,
        ...
        JOptionPane.showMessageDialog(this.parent, Game.i18n.tr("User {0} successfully deleted", chosenUser));
      }
    } else {
      JOptionPane.showMessageDialog(this.parent, Game.i18n.tr("Sorry, you can't delete the current user."), Game.i18n.tr("Try again"),
