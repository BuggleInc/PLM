...
public class MainFrame extends JFrame {
  ...
  public void initComponents()
  {
    ...
    JToggleButton colorButton    = createButton("colors", new ActionListener() {
      public void actionPerformed(ActionEvent e)
      {
        ...
        Object[] choices = {"custom", "black", "blue", "cyan", "darkGray", "gray", "green", "lightGray", "magenta", "orange", "pink", "red", "yellow"};
        Color[] colors   = {new Color(42, 42, 42), Color.black,   Color.blue,   Color.cyan, Color.darkGray, Color.gray,  Color.green,
                               Color.lightGray,       Color.magenta, Color.orange, Color.pink, Color.red,      Color.yellow};

        Object selectedValue = JOptionPane.showInputDialog(null, "Choose a color", "Change color", JOptionPane.INFORMATION_MESSAGE, null, choices,
                                                              choices[editor.getSelectedColorNumber()]);

        if (selectedValue == null) // cancel pressed
          return;

        if (selectedValue.equals("custom")) {
          String name = JOptionPane.showInputDialog("What color you want (r/g/b)", colors[0].getRed() + "/" + colors[0].getGreen() + "/" + colors[0].getBlue());
          try {
  ...
  class NewMapAction extends AbstractAction {
    ...
    public NewMapAction() { super(i18n.tr("Create New Map")); }
  ...
  class SaveMapAction extends AbstractAction {
    ...
    public SaveMapAction() { super("Save As..."); }
  ...
  class OpenMapAction extends AbstractAction {
    ...
    public OpenMapAction() { super(i18n.tr("Open Map...")); }
  ...
  class QuitAction extends AbstractAction {
    ...
    public QuitAction() { super("Quit Map Editor"); }
