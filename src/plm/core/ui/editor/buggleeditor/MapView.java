...
public class MapView extends BuggleWorldView implements EditionListener {
    ...
    MouseListener mouseListener = new MouseAdapter() {
      ...
      void handleMouseEvt(MouseEvent e)
      {
        ...
        if (cmd.equals("topwall")) {
          ...
          String inputValue =
              (String)JOptionPane.showInputDialog(null, "Choose a new message", "Change message", JOptionPane.QUESTION_MESSAGE, null, null, cell.getContent());
          ...
          int option = JOptionPane.showConfirmDialog(null, "Do you really want to delete line " + y + "? (no undo possible)", "Are you sure?",
          ...
          int option = JOptionPane.showConfirmDialog(null, "Do you really want to delete column " + x + "? (no undo possible)", "Are you sure?",
                                                     JOptionPane.ERROR_MESSAGE);
          if (option == JOptionPane.OK_OPTION) {
            BuggleWorld w = editor.getWorld();
          ...
          int option = JOptionPane.showOptionDialog(null, "Add a line above or below the line " + y + "?", "Above or below?", 0,
          ...
          int option = JOptionPane.showOptionDialog(null, "Add a column left or right of column " + x + "?", "Left or Right?", 0,
                                                    JOptionPane.INFORMATION_MESSAGE, null, choices, choices[0]);
          switch (option) {
            case 0:
              break;
  ...
  @Override public void worldEdited()
  {
    worldHasChanged(); // use the callbacks of the regular view -- not really clean but efficient
  }

  @Override public void selectedChanged(int x, int y, Entity ent)
  {
