...
public class Editor {
  ...
  public BuggleWorld getWorld() { return this.world; }

  public void addEditionListener(EditionListener v) { this.editionListeners.add(v); }

  public void removeEditionListener(EditionListener v) { this.editionListeners.remove(v); }
  ...
  public void setSelectedColor(Color c) { selectedColor = c; }
  public Color getSelectedColor() { return selectedColor; }

  public int getSelectedColorNumber() { return selectedColorNumber; }

  public void setSelectedColorNumber(int i) { selectedColorNumber = i; }
