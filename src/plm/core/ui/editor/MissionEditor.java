...
public class MissionEditor extends JFrame {
  ...
  private void initComponents()
  {
    ...
    final ItemListener il = new ItemListener() {
      @Override public void itemStateChanged(ItemEvent arg0)
      {
        ...
        if (selectorAll.isSelected()) {
          ctn = "<html><head>" + PlmHtmlEditorKit.getCSS() + "</head><body>" + PlmHtmlEditorKit.filterHTML(editor.getText(), true, false, null) +
                "</body></html>";
        } else {
          ...
          ctn = "<html><head>" + PlmHtmlEditorKit.getCSS() + "</head><body>" + PlmHtmlEditorKit.filterHTML(editor.getText(), false, true, array) +
                "</body></html>";
        }
    ...
    editor.getDocument().addDocumentListener(new DocumentListener() {
      private void updateHTML()
      {
        ...
        String ctn =
            "<html><head>" + PlmHtmlEditorKit.getCSS() + "</head><body>" + PlmHtmlEditorKit.filterHTML(editor.getText(), true, false, null) + "</body></html>";
        display.setText(ctn);
        javax.swing.text.Document doc = display.getDocument();
        int pos                       = (int)((double)doc.getLength() * editor.getCaretPosition() / editor.getDocument().getLength());
        if (pos > doc.getLength())
  ...
  {
    if (modified) {
      int choice = JOptionPane.showConfirmDialog(MissionEditor.this, Game.i18n.tr("You did not save you changes. Do you want to save it before quiting?"),
                                                 Game.i18n.tr("Save or loose your change?"), JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
  ...
  class SaveMissionAction extends AbstractAction {
    ...
    public SaveMissionAction() { super("Save"); }
  ...
  class SaveAsMissionAction extends AbstractAction {
    ...
    public SaveAsMissionAction() { super("Save As..."); }
  ...
  class OpenMissionAction extends AbstractAction {
    ...
    public OpenMissionAction() { super(i18n.tr("Open Mission...")); }

    @Override public void actionPerformed(ActionEvent e)
    {
      if (modified) {
        int choice =
            JOptionPane.showConfirmDialog(MissionEditor.this, Game.i18n.tr("You did not save you changes. Do you want to save it before opening another file?"),
                                          Game.i18n.tr("Save or loose your change?"), JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
          ...
          if (path.endsWith("." + lang[1] + ".html")) {
            int choice = JOptionPane.showConfirmDialog(
                ...
                Game.i18n.tr("You chose a translated mission text for edition ({0}).\n"
                                 ...
                                 + "Proceed anyway?",
                             path),
                Game.i18n.tr("This is a translated mission text"), JOptionPane.YES_NO_OPTION, JOptionPane.ERROR_MESSAGE);
  ...
  class QuitAction extends AbstractAction {
    ...
    public QuitAction() { super(i18n.tr("Quit Map Editor")); }

    @Override public void actionPerformed(ActionEvent e) { confirmQuit(); }
  }
}
