...
public class FeedbackDialog extends JDialog {
  ...
  public static FeedbackDialog getInstance()
  {
    ...
    defaultText  = FeedbackDialog.instance.i18n.tr("Your suggestion comes here, with all necessary details.\n\n\n\n\n\n"
    ...
    FeedbackDialog.instance.feedback.setText(
        ...
        + "Java version: " + System.getProperty("java.version") + " (VM: " + System.getProperty("java.vm.name") +
  ...
  public void initComponent()
  {
    ...
    hints.setText(
        i18n.tr("<h1>Asking a question about the PLM</h1>\n"
                ...
                + "<p>You should include all relevant information that could help us fixing the issue. Don't remove the technical details unless you are "
                + "certain that they are not relevant. "
    ...
    cancelBtn.addActionListener(new ActionListener() {
      ...
      {
        int dialogResult = JOptionPane.showConfirmDialog(cancelBtn, i18n.tr("Do you really want to cancel your feedback and lose any edit?"),
                                                         i18n.tr("are you sure?"), JOptionPane.YES_NO_OPTION);
      ...
      @Override public void actionPerformed(ActionEvent e)
      {
        if (isCorrect()) {
          ...
          try {
            ...
            JOptionPane.showMessageDialog(sendBtn,
                                          i18n.tr("Thank you for your remark, we will do our best to integrate it.\n"
                                                      + "Follow our progress at {0}.",
                                                  i.getHtmlUrl()),
                                          i18n.tr("Thanks for your suggestion"), JOptionPane.INFORMATION_MESSAGE);
            dispose();
            ...
            JOptionPane.showMessageDialog(cancelBtn, ctn.toString(), i18n.tr("Error while uploading your feedback"), JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
          }
        } else {
          JOptionPane.showMessageDialog(
              FeedbackDialog.this, i18n.tr("Your feedback needs some little changes before being send,\nplease fix the following issue(s):\n\n") + errorMsg,
              i18n.tr("Incorrect feedback"), JOptionPane.ERROR_MESSAGE);
        }
      }
    });
