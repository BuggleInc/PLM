...
public class WorldComboListAdapter extends AbstractListModel<World> implements ComboBoxModel<World>, GameListener {
  ...
  @Override public World getElementAt(int index) { return currentExercise == null ? null : this.currentExercise.getWorld(index); }

  @Override public int getSize() { return currentExercise == null ? 0 : currentExercise.getWorldCount(); }

  @Override public Object getSelectedItem() { return currentExercise == null ? null : selectedWorld; }
