...
public abstract class WorldView extends JComponent implements IWorldView {
  ...
  @Override public void worldHasChanged() { /* nothing specific to do here since we already react to HasMoved */ }

  public boolean isWorldCompatible(World world) { return world.getClass().equals(this.world.getClass()); }
