...
public class EntityComboListAdapter extends AbstractListModel<Entity> implements ComboBoxModel<Entity>, GameListener {
  ...
  @Override public Entity getElementAt(int index) { return this.worlds[0].getEntity(index); }

  @Override public int getSize() { return worlds == null || worlds[0] == null ? 0 : this.worlds[0].getEntityCount(); }

  @Override public Entity getSelectedItem() { return this.game.getSelectedEntity(); }
  ...
  @Override public void selectedWorldHasChanged(World w)
  {
    this.worlds = this.game.getSelectedWorlds();
    fireContentsChanged(this, 0, this.worlds[0].getEntityCount() - 1);
  }

  @Override public void selectedEntityHasChanged() { fireContentsChanged(this, 0, this.worlds[0].getEntityCount() - 1); }

  @Override public void selectedWorldWasUpdated() { fireContentsChanged(this, 0, this.worlds[0].getEntityCount() - 1); }
}
