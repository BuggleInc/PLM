...
public class ExerciseView extends JPanel implements GameListener, HumanLangChangesListener {
  ...
  public void selectObjectivePane() { tabPane.setSelectedIndex(1); }

  public void selectWorldPane() { tabPane.setSelectedIndex(0); }

  @Override public void currentExerciseHasChanged(Lecture lect)
  {
    if (worldComboBox != null)
      worldComboBox.setVisible(lect instanceof Exercise && ((Exercise)lect).getWorldCount() > 1);
  }

  @Override public void selectedWorldHasChanged(World newWorld)
  {
...
class DelayBoundedRangeModel implements BoundedRangeModel, GameListener {
  ...
  @Override public int getMaximum() { return this.max; }

  @Override public void setMaximum(int newMaximum) { this.max = newMaximum; }

  @Override public int getMinimum() { return this.min; }

  @Override public void setMinimum(int newMinimum) { this.min = newMinimum; }

  @Override public int getValue() { return game.getSelectedWorld() == null ? 0 : game.getSelectedWorld().getDelay(); }
  ...
  @Override public boolean getValueIsAdjusting() { return isAdjusting; }

  @Override public void setValueIsAdjusting(boolean b) { setRangeProperties(game.getSelectedWorld().getDelay(), extent, min, max, b); }

  @Override public int getExtent() { return this.extent; }

  @Override public void setExtent(int n)
  {
  ...
  @Override public void setRangeProperties(int newValue, int newExtent, int newMin, int newMax, boolean adjusting)
  {
    if (newMin > newMax) {
      newMin = newMax;
    }
    ...
    boolean isChange =
        (newValue != game.getSelectedWorld().getDelay()) || (newExtent != extent) || (newMin != min) || (newMax != max) || (adjusting != isAdjusting);
  ...
  @Override public void addChangeListener(ChangeListener x) { listenerList.add(ChangeListener.class, x); }

  @Override public void removeChangeListener(ChangeListener x) { listenerList.remove(ChangeListener.class, x); }
  ...
  @Override public void currentExerciseHasChanged(Lecture lect) { /* don't care */ }

  @Override public void selectedWorldHasChanged(World w) { fireStateChanged(); }

  @Override public void selectedEntityHasChanged() { /* don't care */ }

  @Override public void selectedWorldWasUpdated() { fireStateChanged(); }
}
