...
public class PlmHtmlEditorKit extends HTMLEditorKit {
    ...
    public static String filterHTML(String in, boolean showAll, boolean showMulti, ProgrammingLanguage[] currLang, ProgrammingLanguage targetLang) {
        if (langColors == null) {
    ...
    protected static Exercise baseExercise = null;

    public PlmHtmlEditorKit() {
        baseExercise = null;
    }

    public PlmHtmlEditorKit(Exercise _baseExercise) {
...
class MyIconView extends View {
     ...
     */
    public MyIconView(Element elem, Exercise baseExercise) {
        super(elem);
        String filename = (String) elem.getAttributes().getAttribute(HTML.Attribute.SRC);
        if (filename == null) {
            if (baseExercise == null)
                System.err.println("<img> tag without src attribute at offset " + elem.getStartOffset());
            else
                System.err.println("<img> tag without src attribute in exercise " + baseExercise.getName() + " at offset " + elem.getStartOffset());
