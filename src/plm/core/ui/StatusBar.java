...
public class StatusBar extends JPanel implements GameListener, GameStateListener, StatusStateListener, ProgLangChangesListener, HumanLangChangesListener {
  ...
  public void initComponents()
  {
    ...
    progLangLabel.addMouseListener(new MouseListener() {
      ...
      {
        progLangPopup.show(e.getComponent(), e.getX(), e.getY());
      }
    ...
    humLangLabel.addMouseListener(new MouseListener() {
      ...
      public void mouseClicked(MouseEvent e)
      {
        humLangPopup.show(e.getComponent(), e.getX(), e.getY());
      }
      void maybeShowPopup(MouseEvent e)
      {
        if (e.isPopupTrigger())
  ...
  @Override public void stateChanged(final String txt)
  {
  ...
  @Override public void currentProgrammingLanguageHasChanged(ProgrammingLanguage newLang) { progLangLabel.setIcon(newLang.getIcon()); }
  @Override public void currentExerciseHasChanged(Lecture lecture) { setupProgLanguages(lecture); }
  @Override public void selectedWorldHasChanged(World newWorld) { /* don't care */ }
  @Override public void selectedEntityHasChanged() { /* tell your mum */ }
  @Override public void selectedWorldWasUpdated() { /* go away */ }

  @Override public void currentHumanLanguageHasChanged(Locale newLang) { humLangLabel.setText(newLang.getLanguage()); }
}
