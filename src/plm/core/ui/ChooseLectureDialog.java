...
public class ChooseLectureDialog implements TreeSelectionListener {
  ...
  public ChooseLectureDialog()
  {
    ...
    tree.setCellRenderer(new DefaultTreeCellRenderer() {
      ...
      @Override public Component getTreeCellRendererComponent(JTree tree, Object o, boolean selected, boolean expanded, boolean leaf, int row, boolean hasFocus)
      {
    ...
    int result = JOptionPane.showConfirmDialog(MainFrame.getInstance(), p, Game.i18n.tr("Choose your next exercise"), JOptionPane.OK_CANCEL_OPTION,
