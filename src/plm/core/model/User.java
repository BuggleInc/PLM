...
public class User implements JSONStreamAware {
  ...
  public User()
  {
    ...
    final File gitDir = new File(Game.getSavingLocation() + System.getProperty("file.separator") + getUserUUIDasString());
    if (!gitDir.exists()) {
      gitDir.mkdir();
    }
  ...
  @SuppressWarnings({"unchecked", "rawtypes"}) public void writeJSONString(Writer out) throws IOException
  {
  ...
  @Override public String toString() { return username + " [" + String.valueOf(userUUID).substring(0, 8) + "]"; }

  public String toStringExtended() { return "User [username=" + username + ", lastUsed=" + lastUsed + ", userUUID=" + userUUID + "]"; }
  ...
  public String getUserUUIDasString() { return this.userUUID.toString(); }

  public UUID getUserUUID() { return userUUID; }

  public String getCurrentExercise() { return currentExo; }
