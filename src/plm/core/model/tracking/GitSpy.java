...
public class GitSpy implements ProgressSpyListener, UserSwitchesListener {
	...
	private String writeCommitMessage(Exercise exoFrom, Exercise exoTo, String evt_type, JSONObject logmsg) {
        ...
        @SuppressWarnings("unchecked") private String writePLMStartedOrLeavedCommitMessage(String kind)
        {
          ...
          jsonObject.put("os", System.getProperty("os.name") + " (version: " + System.getProperty("os.version") +
                                   "; arch: " + System.getProperty("os.arch") + ")");
          jsonObject.put("plm", Game.getProperty("plm.major.version", "internal", false) + " (" +
