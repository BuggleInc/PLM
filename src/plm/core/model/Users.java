...
public class Users {
   ...
   */
  @SuppressWarnings("rawtypes") private void loadUsersFromFile(File userDBFile)
  {
    synchronized (this) {
      ...
      if (!this.userDBFile.exists()) {
        ...
        try {
          ...
          while (iter.hasNext()) {
            @SuppressWarnings("unchecked") HashMap<String, Object> entry = (HashMap<String, Object>)iter.next();
  ...
  public void addUserSwitchesListener(UserSwitchesListener l) { userSwitchesListeners.add(l); }
  public void fireUserSwitch(User newUser)
  {
    for (UserSwitchesListener l : userSwitchesListeners)
      l.userHasChanged(newUser);
  }
  public void removeUserSwitchesListener(UserSwitchesListener l) { this.userSwitchesListeners.remove(l); }
}
