...
public abstract class Lecture {
  ...
  public String getName() { return PlmHtmlEditorKit.filterHTML(name, false); }

  public Lesson getLesson() { return this.lesson; }

  public String getMission(ProgrammingLanguage lang)
  {
    String res = "<html><head>" + PlmHtmlEditorKit.getCSS() + "</head><body>" + PlmHtmlEditorKit.filterHTML(this.mission, Game.getInstance().isDebugEnabled()) +
                 "</body></html>";
    return res;
  }
  public void setMission(String mission) { this.mission = mission; }
  public String getTip(String tipsId) { return PlmHtmlEditorKit.filterHTML(this.tips.get(tipsId), Game.getInstance().isDebugEnabled()); }
