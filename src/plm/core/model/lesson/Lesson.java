...
public abstract class Lesson {
  ...
  public void resetAboutLoaded() { this.aboutLoaded = false; }
  ...
  Lecture rootExo;
  public Vector<Lecture> getRootLectures() { return rootLectures; }
  ...
  public void setCurrentExercise(Lecture exo) { this.currentExercise = exo; }
  public void setCurrentExercise(String exoName) { setCurrentExercise(getExercise(exoName)); }

  public int exerciseCount() { return this.lectures.size(); }

  public List<Lecture> exercises() { return this.lectures; }
  public Lecture getExercise(String name)
  {
    String searchedName = getClass().getPackage().getName() + "." + name;
    for (Lecture l : lectures) {
      if (l.getClass().getCanonicalName().equals(searchedName) || l.getClass().getCanonicalName().equals(name) || l.getId().equals(searchedName) ||
          l.getId().equals(name) || l.getLocalId().equals(searchedName) || l.getLocalId().equals(name))
        return l;
    }
    return null;
  }
  public int getExerciseCount() { return this.lectures.size(); }

  public LoadingOutcome getLoadingOutcomeState() { return LoadingOutcomeState; }
  public void setLoadingOutcomeState(LoadingOutcome loadingOutcomeState) { LoadingOutcomeState = loadingOutcomeState; }
}