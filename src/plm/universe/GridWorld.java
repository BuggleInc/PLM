...
public abstract class GridWorld extends World {
  ...
  public GridWorldCell getCell(int x, int y) { return this.cells[x][y]; }
  ...
  public boolean getVisibleGrid() { return visibleGrid; }
  public void setVisibleGrid(boolean s) { visibleGrid = s; }
}
