...
public class BuggleWorldCell extends GridWorldCell {
  ...
  public BuggleWorldCell(BuggleWorld w, int x, int y) { this(w, x, y, DEFAULT_COLOR, false, false, false, ""); }
  ...
  public BuggleWorldCell copy(GridWorld w) { return new BuggleWorldCell(this, w); }

  public BuggleWorldCell(BuggleWorld w, int x, int y, Color color, boolean leftWall, boolean topWall) { this(w, x, y, color, leftWall, topWall, false, ""); }
  ...
  public Color getMsgColor() { return this.msgColor; }
  ...
  public boolean hasTopWall() { return this.topWall; }

  public boolean hasLeftWall() { return this.leftWall; }

  public boolean hasBaggle() { return hasBaggle; }
  ...
  public boolean hasContent() { return (!this.content.equals("")); }
  ...
  public String diffTo(BuggleWorldCell current)
  {
    ...
    if (color == null) {
      ...
      sb.append(this.world.i18n.tr(", the ground is expected to be {0}, but it is {1}", ColorMapper.color2translated(color),
                                   ColorMapper.color2translated(current.color)));
    }
