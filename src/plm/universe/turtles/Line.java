...
public class Line implements Shape {
  ...
  public Line copy() { return new Line(x1, y1, x2, y2, color); }
  public static boolean doubleEqual(double a, double b) { return (Math.abs(a - b) < 0.01); }
  public static boolean doubleApprox(double a, double b) { return (Math.abs(a - b) < 1); }
  ...
  @Override public String toString()
  {
    ...
    return String.format(Locale.ENGLISH, "Line (x%.3f y%.3f / x%.3f y%.3f / %s) %s", x1, y1, x2, y2, plm.core.utils.ColorMapper.color2name(color), slope);
  }
}
