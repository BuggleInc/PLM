...
public class TurtleWorldView extends WorldView {
  ...
  @Override public void paintComponent(Graphics g) { doPaint(g, getWidth(), getHeight(), true); }
  public void doPaint(Graphics g, int sizeX, int sizeY, boolean showTurtle)
  {
    ...
    g2.setStroke(new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f, new float[] {2f, 10.0f}, 0.0f));
