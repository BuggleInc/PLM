...
public class Circle implements Shape {
  ...
  @Override public Shape copy() { return new Circle(x, y, radius, color); }
  private boolean doubleEqual(double a, double b) { return (Math.abs(a - b) < 0.000001); }
  @Override public String diffTo(Shape o)
  {
