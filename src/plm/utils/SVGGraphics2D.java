...
public final class SVGGraphics2D extends Graphics2D {
    ...
    private String getSVGFillStyle() {
        ...
        if (getColorAlpha()*getAlpha() != 1.0)
        	b.append("; ").append("fill-opacity: ").append(getColorAlpha() * getAlpha());
        return b.toString();
    }
     ...
     * @param height  the height.
     */
    private void setOval(double x, double y, double width, double height) {
        if (this.oval == null) {
