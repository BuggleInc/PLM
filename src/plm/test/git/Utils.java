...
public class Utils {
  ...
  public String getFileContent(File repoDir, String userUUID, Exercise exo, RunOutcome lastResult, String suffix) throws IOException
  {
  ...
  {
    return repoDir.getPath() + System.getProperty("file.separator") + userUUID + System.getProperty("file.separator") + exo.getId() + "." + pl.getExt() +
        suffix;
  }
