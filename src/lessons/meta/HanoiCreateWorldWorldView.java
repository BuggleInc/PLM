...
public class HanoiCreateWorldWorldView extends WorldView {
	...
	public HanoiCreateWorldWorldView(World w) {
		super(w);
	}
	...
	public boolean isWorldCompatible(World world) {
		return world instanceof HanoiCreateWorldWorld;
	}
	...
	public void paintComponent(Graphics g) {
		...
		if (((HanoiCreateWorld)Game.getInstance().getCurrentLesson().getCurrentExercise()).error) {
			g2.setFont(new Font("Monaco", Font.BOLD, 14));
			g2.setColor(Color.red);
			g2.drawString("An error occured (check the log)", 30, 230);
		}
	}
