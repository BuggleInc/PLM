...
public class Clock implements IClock {
  ...
  public int inSeconds() { return this.hours * 3600 + this.minutes * 60 + this.seconds; }

  public void increment(int nbh, int nbm, int nbs) { this.incrementSeconds(nbh * 3600 + nbm * 60 + nbs); }
  ...
  public void incrementHours(int nbh) { this.hours = this.hours + nbh; }
  ...
  @Override public boolean equals(Object other)
  {
    ...
    return (this.hours == otherClock.hours && this.minutes == otherClock.minutes && this.seconds == otherClock.seconds);
  }
  ...
  @Override public String toString() { return this.hours + "h " + this.minutes + "mn " + this.seconds + "s"; }
}
