...
public class BacktrackingWorld extends World {
   ...
   */
  public BacktrackingWorld(BacktrackingWorld other) { super(other); }
   ...
   */
  @Override public WorldView getView() { return new BacktrackingWorldView(this); }
  @Override public ImageIcon getIcon()
  {
    return ResourcesCache.getIcon("img/world_backtracking.png"); // Yeah, does not exists, I know
  }

  @Override public String toString() { return getName() + "Best Solution: (" + bestSolution + ")"; }
