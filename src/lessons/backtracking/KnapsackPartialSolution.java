...
public class KnapsackPartialSolution extends BacktrackingPartialSolution {
  ...
  protected KnapsackPartialSolution(int maxSize, int[] sizes) { this(maxSize, sizes, sizes); }
  ...
  /* getters */
  public boolean isValid() { return currSize <= maxSize; }
  public int getValue()
  {
  ...
  public int size() { return sizes.length; }

  @Override public KnapsackPartialSolution clone()
  {
