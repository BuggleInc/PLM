...
public class IndexOfMaxValueOfArray extends ArrayExercise {

	public IndexOfMaxValueOfArray(Lesson lesson) {
		super(lesson);
		...
		addEntityKind(myWorlds, new IndexMaxComputation(), "IndexMaxComputation");  
