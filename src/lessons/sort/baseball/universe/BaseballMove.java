...
public class BaseballMove {
  ...
  public int getBaseDst() { return baseDst; }
  public int getBaseSrc() { return baseSrc; }
  public int getPlayerDst() { return playerDst; }
  public int getPlayerSrc() { return playerSrc; }
