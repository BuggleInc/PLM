...
class TransferableLine implements Transferable { // Actually not used, but to prevent people from accepting our own drops
  ...
  public TransferableLine(int _rank) { rank = _rank; }

  @Override public DataFlavor[] getTransferDataFlavors() { return new DataFlavor[] {dutchLineFlavor}; }

  @Override public boolean isDataFlavorSupported(DataFlavor flavor) { return flavor.equals(dutchLineFlavor); }
