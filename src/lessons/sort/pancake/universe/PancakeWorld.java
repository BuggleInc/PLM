...
public class PancakeWorld extends World {
  ...
  /** Copy constructor */
  public PancakeWorld(PancakeWorld world) { super(world); }
  ...
  public void flip(int numberOfPancakes)
  {
    ...
    if (numberOfPancakes > this.getStackSize())
      throw new IllegalArgumentException(
          Game.i18n.tr("Asked to flip {0} pancakes, but there is only {1} pancakes on this stack.", numberOfPancakes, getStackSize()));
  ...
  protected int getLastMove() { return lastMove; }
  protected int getSelectedPancake() { return selected; }
   ...
   */
  public int getStackSize() { return pancakeStack.length; }
  ...
  public boolean isBurnedPancake() { return burnedWorld; }
}
...
class Pancake {
  ...
  public void flip() { upsideDown = !upsideDown; }

  /** Returns the radius of the pancake */
  public int getRadius() { return this.radius; }

  /** Returns whether the pancake is upside down */
  public boolean isUpsideDown() { return this.upsideDown; }
