...
public class PancakeEntity extends Entity implements PancakeEntityPrimitives {
   ...
   */
  public PancakeEntity() { super("Pancake Entity"); }

  /** Copy constructor (used internally) */
  public PancakeEntity(String name) { super(name); }

  /** Instantiation Constructor (used by exercises to setup the world) */
  public PancakeEntity(String name, World world) { super(name, world); }
   ...
   */
  @Override public void flip(int numberOfPancakes)
  {
   ...
   */
  @Override public int getPancakeRadius(int pancakeNumber) { return ((PancakeWorld)world).getPancakeRadius(pancakeNumber); }

  /** Returns the size of the pancake stack */
  @Override public int getStackSize() { return ((PancakeWorld)world).getStackSize(); }

  /**
   * Returns whether the specific pancake (counting from the stack top) is upside down
   */
  @Override public boolean isPancakeUpsideDown(int rank) { return ((PancakeWorld)world).isPancakeUpsideDown(rank); }

  /**
   * Tell if the stack of pancakes is correctly sorted according to the control freak pancake seller
   */
  @Override public boolean isSorted() { return ((PancakeWorld)this.world).isSorted(); }
  /**
  ...
  public String toString() { return "PancakeEntity (" + this.getClass().getName() + ")"; }
