...
public class CohenPancake extends ExerciseTemplated {
	...
	public CohenPancake(Game game, Lesson lesson) {
		...
		PancakeWorld[] plate = new PancakeWorld[] {
				...
				new PancakeWorld(game, "7 pancakes",new int[] {3,6, 1,2,5,4,7},true),  // C  E+ Cbis E+ Cbis
				new PancakeWorld(game, "8 pancakes",new int[] {5,2,7,4,1,6,8,3,},true),  // A+ A+ A+ E+ A- G H
				new PancakeWorld(game, "9 pancakes",new int[] {4,2,3,7,9,1,5,6,8},true), // B+ Cbis A- D+ E+ H
				new PancakeWorld(game, "15 pancackes",new int[] {7, 2, 3, 14, 9, 5, 1, 8, 10, 11, 6, 12, 15, 4, 13, },true), // A+ Cbis A+ D+ E+ G A- B+ E+ F- H
				new PancakeWorld(game, "random 15 pancakes", 15, true),
