...
public class HexaKoch extends ExerciseTemplated {
	...
	public HexaKoch(Game game, Lesson lesson) {
		...
		new Turtle(game, myWorlds[5], "Hawksbill", 100, 250,0, Color.red);
	*/	
		setup(myWorlds);
	}
}
