...
public class PolygonFractal extends ExerciseTemplated {
	...
	public PolygonFractal(Game game, Lesson lesson) {
		...
		new Turtle(game, myWorlds[0], "Hawksbill", 125, 250, -90, Color.red);
		
		myWorlds[1] = new TurtleWorld(game, "polygonFractal(2,5,100,0.5)", 400, 400);
		myWorlds[1].setParameter(new Object[] {2,5,100.,.5});		
		new Turtle(game, myWorlds[1], "Hawksbill", 125, 250, -90, Color.red);
		...
		new Turtle(game, myWorlds[2], "Hawksbill", 125, 250, -90, Color.red);
		...
		new Turtle(game, myWorlds[3], "Hawksbill", 125, 250, -90, Color.red);
		...
		new Turtle(game, myWorlds[4], "Hawksbill", 125, 250, -90, Color.red);
		...
		new Turtle(game, myWorlds[5], "Hawksbill", 125, 250, -90, Color.red);
		...
		new Turtle(game, myWorlds[6], "Hawksbill", 125, 250, -90, Color.red);
