...
public class HanoiBoard extends ExerciseTemplated {
  ...
  public HanoiBoard(Lesson lesson)
  {
    ...
    myWorlds[0]           = new HanoiWorld("solve(0,1,2)", new Integer[] {8, 7, 6, 5, 4, 3, 2, 1}, new Integer[0], new Integer[0]);
    myWorlds[0].setParameter(new Object[] {0, 1, 2});
    myWorlds[1] = new HanoiWorld("solve(2,0,1)", new Integer[0], new Integer[0], new Integer[] {8, 7, 6, 5, 4, 3, 2, 1});
    myWorlds[1].setParameter(new Object[] {2, 0, 1});
    myWorlds[2] = new HanoiWorld("solve(1,2,0)", new Integer[0], new Integer[] {8, 7, 6, 5, 4, 3, 2, 1}, new Integer[0]);
