...
public class TricolorHanoi2 extends ExerciseTemplated {
	...
	public TricolorHanoi2(Game game, Lesson lesson) {
		...
		w = new HanoiWorld(game, "gather(0,1,2)", new Integer[] {4,3,2,1}, new Integer[] {4,3,2,1},new Integer[] {4,3,2,1});
		...
		w = new HanoiWorld(game, "gather(1,2,0)", new Integer[] {4,3,2,1}, new Integer[] {4,3,2,1},new Integer[] {4,3,2,1});
		...
		w = new HanoiWorld(game, "gather(2,0,1)", new Integer[] {4,3,2,1}, new Integer[] {4,3,2,1},new Integer[] {4,3,2,1});
