...
public class HanoiWorldView extends WorldView {
  ...
  class HanoiDropTargetListener implements DropTargetListener {
    @Override public void dragEnter(DropTargetDragEvent dtde) { setCursor(DragSource.DefaultMoveDrop); }
    int lastPeg = -1;
    ...
    @Override public void dropActionChanged(DropTargetDragEvent dtde) { /* tell your mum */ }
    @Override public void dragExit(DropTargetEvent dte) { setCursor(Cursor.getDefaultCursor()); }
  ...
  class HanoiDragSourceListener implements DragSourceListener {
    ...
    @Override public void dragEnter(DragSourceDragEvent dsde) { outside = false; }
    @Override public void dragOver(DragSourceDragEvent dsde) { /* */ }
    @Override public void dropActionChanged(DragSourceDragEvent dsde) { /* */ }
    @Override public void dragExit(DragSourceEvent dse) { outside = true; }
...
class TransferableHanoiPiece implements Transferable {
  ...
  public TransferableHanoiPiece(int _pegFrom) { pegFrom = _pegFrom; }

  @Override public DataFlavor[] getTransferDataFlavors() { return new DataFlavor[] {hanoiDataFlavor}; }

  @Override public boolean isDataFlavorSupported(DataFlavor flavor) { return flavor.equals(hanoiDataFlavor); }
