...
public class SplitHanoi1 extends ExerciseTemplated {
	...
	public SplitHanoi1(Lesson lesson) {
		...
		HanoiWorld[] myWorlds = new HanoiWorld[1];//3];
		HanoiWorld w;
		w = new HanoiWorld("solve(3,2,0,1)",  
				new Integer[0], new Integer[0],new Integer[0], new Integer[] {5,5,4,4,3,3,2,2,1,1});
		...
		w = new HanoiWorld("slove(1,3,0,2)",  
				new Integer[0], new Integer[]{5,5,4,4,3,3,2,2,1,1},new Integer[0],new Integer[0]);
