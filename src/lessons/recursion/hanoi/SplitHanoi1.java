...
public class SplitHanoi1 extends ExerciseTemplated {
  ...
  public SplitHanoi1(Lesson lesson)
  {
    ...
    HanoiWorld w;
    w = new HanoiWorld("solve(3,2,0,1)", new Integer[0], new Integer[0], new Integer[0], new Integer[] {7, 7, 6, 6, 5, 5, 4, 4, 3, 3, 2, 2, 1, 1});
    ...
    w = new HanoiWorld("solve(1,3,0,2)", new Integer[0], new Integer[] {6, 6, 5, 5, 4, 4, 3, 3, 2, 2, 1, 1}, new Integer[0], new Integer[0]);
    ...
    w = new HanoiWorld("solve(2,1,0,3)", new Integer[0], new Integer[0], new Integer[] {5, 5, 4, 4, 3, 3, 2, 2, 1, 1}, new Integer[0]);
    ...
    myWorlds = Arrays.stream(myWorlds).map(s -> s.replaceEntities(SplitHanoi1Entity::new)).toList().toArray(new HanoiWorld[0]);
    setup(myWorlds);
  }
}
