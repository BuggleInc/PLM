...
public class LightBotWorldCell extends GridWorldCell {
  ...
  public LightBotWorldCell(GridWorld w, int x, int y) { this(w, x, y, false, false, 0); }

  public LightBotWorldCell(LightBotWorldCell c, GridWorld w) { this(w, c.x, c.y, c.light, c.lightOn, c.height); }
  @Override public GridWorldCell copy(GridWorld world) { return new LightBotWorldCell(this, world); }
  ...
  public boolean getLightOnOrNone() { return (!light) || lightOn; }
