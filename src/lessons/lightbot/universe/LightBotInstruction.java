...
public class LightBotInstruction {
  ...
  public LightBotInstruction(InstructionKind kind) { this.kind = kind; }
  ...
  public static LightBotInstruction noop() { return new LightBotInstruction(InstructionKind.NOOP); }
  ...
  public boolean isNoop() { return kind == InstructionKind.NOOP; }
}
