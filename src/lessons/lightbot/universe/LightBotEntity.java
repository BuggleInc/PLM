...
public class LightBotEntity extends Entity {
  ...
  public int getWorldHeight() { return ((GridWorld)world).getHeight(); }

  public int getWorldWidth() { return ((GridWorld)world).getWidth(); }
  public LightBotWorldCell getCell() { return (LightBotWorldCell)((GridWorld)world).getCell(getX(), getY()); }
  protected LightBotWorldCell getCell(int u, int v) { return (LightBotWorldCell)((GridWorld)world).getCell(u, v); }
  ...
  public void jump()
  {
    ...
    if ((heightThere - heightHere == 1 /*jump one up*/) || (heightHere > heightThere /*jump down*/))
      move();
    else
  ...
  public void left() { direction = getDirection().left(); }
  public void right() { direction = getDirection().right(); }
  public void light() { ((LightBotWorld)world).switchLight(getX(), getY()); }

  @Override public String toString() { return "LightBot (" + this.getClass().getName() + "): x=" + getX() + " y=" + getY() + " Direction:" + direction; }
  ...
  public void runF1() { run("func1", sf.getFunc1()); }
  public void runF2() { run("func2", sf.getFunc2()); }
  ...
  @Override public StackTraceElement[] getCurrentStack() { return tracedStack; }
}
