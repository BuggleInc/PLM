...
public abstract class AbstractTurtle extends Entity {
	@Attribute
	private Color color;
	...
	public AbstractTurtle(TurtleWorld w) {
		this(w, "John Doe", 0., 0., 0., Color.red);
	}
	public AbstractTurtle(TurtleWorld w, String name) {
		this(w, name, 0., 0., 0., Color.red);
	}

	public AbstractTurtle(TurtleWorld world, String name, double x, double y, double heading, Color c) {
		super(name,world);
		this.color = c;
		this.x = x;
		this.y = y;
	...
	public AbstractTurtle(AbstractTurtle t) {
		super(t.getName(),t.getWorld());
		this.color = t.color;
		this.x = t.x;
		this.y = t.y;
	...
	public void copy(Entity e) {
		super.copy(e);
		AbstractTurtle other = (AbstractTurtle)e;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof AbstractTurtle))
			return false;
		
		final AbstractTurtle other = (AbstractTurtle) obj;
		if (color == null) {
			if (other.color != null)
				return false;
